...
example /usr/src/bbqcoin, AND not under, for example, /mnt/d/bbqcoin. 
...
way. This will install to `c:\workspace\bbqcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/bbqcoin
