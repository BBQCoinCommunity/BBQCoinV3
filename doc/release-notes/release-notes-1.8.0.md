...
use "bbqcoind" you must run it the first time with the "-reindex" command line
option.
...
assigned numbers. DIP standards can be found at https://github.com/bbqcoin/dips/ .
...
A problem in parsing mangled bbqcoin: URIs under Windows has been resolved, and as
part of this work network detection for bbqcoin: URIs is now more robust.
