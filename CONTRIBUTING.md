# Contributing to BBQCoin Core

BBQCoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

- [Help requests](https://github.com/BBQCoinCommunity/BBQCoinV3/labels/help%20wanted)
- [Projects](https://github.com/BBQCoinCommunity/BBQCoinV3/projects)
- [bbqcoindev on reddit](https://www.reddit.com/r/bbqcoindev/)

## Branch Strategy

BBQCoin Core's default branch is intentionally a stable release, so that anyone
...
BBQCoin Core is a direct fork of Bitcoin Core and therefore benefits from as
