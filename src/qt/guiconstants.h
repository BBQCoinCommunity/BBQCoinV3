...
#define QAPP_ORG_NAME "BBQCoin"
#define QAPP_ORG_DOMAIN "BBQCOIN.DOMAIN"
#define QAPP_APP_NAME_DEFAULT "BBQCoin-Qt"
#define QAPP_APP_NAME_TESTNET "BBQCoin-Qt-testnet"
