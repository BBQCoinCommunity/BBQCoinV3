 ...
 *
 *  bbqcoin:    Increment mempool limits and accept RBF in steps of 0.0001 DOGE
...
/**
 * bbqcoin: Default dust limit that is evaluated when considering whether a
...
/**
 * bbqcoin: Default hard dust limit that is evaluated when considering whether
