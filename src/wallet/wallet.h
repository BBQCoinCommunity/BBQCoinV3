...
/*
 * bbqcoin: Scaled to 1/10th of the recommended transaction fee to make RBF
...
/*
 * bbqcoin: Creating change outputs at exactly the dustlimit is counter-
...
public:
    ...
    /**
     * BBQCoin: Get a fee targetting a specific transaction speed.
     */
