...
BOOST_AUTO_TEST_CASE(hardfork_parameters)
{
    ...
    BOOST_CHECK_EQUAL(initialParams.AllowLegacyBlocks(0), false); // Start at 173700
    ...
    BOOST_CHECK_EQUAL(initialParamsEnd.AllowLegacyBlocks(144999), false); // Start at 173700
    ...
    BOOST_CHECK_EQUAL(digishieldParams.AllowLegacyBlocks(145000), false); // Start at 173700
    ...
    BOOST_CHECK_EQUAL(digishieldParamsEnd.AllowLegacyBlocks(371336), true); // Start at 173700
    ...
    BOOST_CHECK_EQUAL(auxpowParams.AllowLegacyBlocks(371337), true); // Start at 173700
    ...
    BOOST_CHECK_EQUAL(auxpowHighParams.AllowLegacyBlocks(700000), true); // Start at 173700
